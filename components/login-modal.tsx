...
export function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md mx-auto p-8 max-h-[90vh] overflow-y-auto">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <form onSubmit={handleEmailLogin} className="space-y-6">
          ...
          <div className="flex justify-center">
            <button
              ...
              disabled={isLoading}
              className="h-11 px-8 flex items-center justify-center space-x-3 border border-gray-400 rounded-lg text-gray-700 font-medium hover:bg-gray-50 shadow-sm hover:shadow-md transition-all disabled:opacity-50"
            >
